...
const slides = [
  {
    name: "Amanda Rosangela",
    age: "48 anos",
    city: "Garça",
    avatar: "/icon-assessment-1.png",
    background: "/bg-assessment-1.png",
    testimonial:
      "“É incrível, após o tratamento eu voltei a sorrir e a tirar fotos sem me envergonhar”",
  },
  {
    name: "Carlos Alberto",
    age: "32 anos",
    ...
    testimonial:
      "“Agora posso falar em público com segurança e sorrir à vontade.”",
  },
  {
    name: "Fernanda Souza",
    age: "64 anos",
    ...
    testimonial:
      "“Minha autoestima melhorou muito! Obrigada pelo cuidado e profissionalismo.”",
  },
  {
    name: "Amanda Rosangela",
    age: "48 anos",
...
export default function Assessment() {
  ...
  return (
    <section className="flex flex-col justify-center items-center p-5 py-10 bg-grandient">
      <h1 className="sm:text-[32px] text-[24px] mb-10 uppercase max-w-[500px] text-center">
        Venha sorrir igual a eles.
      </h1>
            ...
            <SwiperSlide key={i}>
              <div className="relative flex justify-end align-end h-full w-full">
                ...
                <div className="flex flex-col justify-center items-center bg-white rounded-2xl text-[var(--text-secondary)] pb-5 pt-7 px-4 absolute bottom-0 mx-5 mb-5">
                  <figure className="bg-white absolute top-[-32px] rounded-full p-2 max-w-[60px] max-h-[60px]">
                    <Image
                      src={slide.avatar}
                      alt={`Avatar de ${slide.name}`}
