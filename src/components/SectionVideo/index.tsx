    ...
    return(
        <section className="py-10 mb-10">
            <div className="flex justify-center items-center flex-col text-center sm:px-10 px-5 max-w-[1000px] m-auto">
                <h1 className="mb-5 lg:text-[30px] sm:text-[24px] text-[22px] font-semibold text-[var(--background-primary)]">Entenda como funciona o Protocolo Fixo e transforme seu sorriso de forma segura</h1>
